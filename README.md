...
This dataset is used as the basis for the first chapter of my doctoral dissertation at the University of Washington: "Penitential Pilgrims: Indigenous Truth Commissions in the Northwest Coast." The code for analysis is included in this repository but the data itself is hosted on a MySQL server. If you are interested in the raw data, please let me know you'd like to connect to the server.
